...
/* In the review URL the central Both/Dose slider stays active: one drag moves 0–3 shared levels. */
(() => {
  let dose = null;
  const rerender = () => { root.innerHTML = v4Control(); };
...
/* r31 temporarily made control review pages live; retain the static page and only re-enable Dose above. */
